...
<template>
  <svg class="sd-svg"
    ...
    <path class="sd-svg__stroke"
      ...
      d="M24 7.97C24 6.88 23.12 6 22.03 6H9.98C8.89 6 8 6.88 8 7.97V24.03C8 25.12 8.89 26 9.98 26H22.03C23.12 26 24 25.12 24 24.03V7.97Z"/>
    <path class="sd-svg__stroke"
      :class="cssStrokeClssArr"
      d="M20 10H12V14.05H20V10Z"/>
  </svg>
</template>
