    ...
    <div class="sd-block__cont" v-if="isExpanded">
      ...
      <div class="sd-list">
        <button class="sd-button" 
          ...
          @click="selectedStatus.statusSale = statSale.name">
          <span class="sd-button__cont">
            <span class="sd-button__txt">
              {{ statSale.lang.ca }}
            </span>

            <span v-if="statSale.name == selectedStatus.statusSale">
              *
            </span>
          </span>
        </button>
      ...
      <div class="sd-list">
        <button class="sd-button" 
          ...
          @click="selectedStatus.statusDev = statDev.name">
          <span class="sd-button__cont">
            <span class="sd-button__txt">
              {{ statDev.lang.ca }}
            </span>

            <span v-if="statDev.name == selectedStatus.statusDev">
              *
            </span>
          </span>
        </button>
      ...
      <div class="sd-list">
        <button class="sd-button" 
          ...
          @click="selectedStatus.typeDev = typeDev.name">
          <span class="sd-button__cont">
            <span class="sd-button__txt">
              {{ typeDev.lang.ca }}
            </span>

            <span v-if="typeDev.name == selectedStatus.typeDev">
              *
            </span>
          </span>
        </button>
